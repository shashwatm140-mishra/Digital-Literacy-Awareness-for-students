...
## 📌 Project Overview
This project is created as part of the Digital Literacy course. It focuses on developing essential digital skills such as creating awareness content, building a professional online presence, using online platforms, practicing email etiquette, and understanding cybercrime.

## 📂 Project Structure

- task-1-presentation → Digital Literacy Infographic  
- task-2-portfolio → Online profiles (GitHub, LinkedIn, HackerRank)  
